...
(tabela <- tibble(PL = as.character(glue("{ipsum_starts(30)} {ipsum_starts(30)}")),
...
Agora precisamos desaninhar essa lista em texto. Passamos a execução de ``map2()`` como argumento de outro mapeamento, agora com saída definida como vetor de texto, que a cada elemento da lista recebida colapsa todos, separando os elementos com uma vírgula e espaço.
