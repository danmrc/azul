...
Agora sim podemos estimar os modelos com o código original em Stata:
...
* O console sai no documento então para ver o resultao de uma linha de código, é preciso compilar o documento todo e conferir a saída lá

* Cada chunk de código em Stata gera uma sessão nova, então é preciso _sempre_ importar os dados 