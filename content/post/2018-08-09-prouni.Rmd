...
```{r imagem1, echo=FALSE, message=FALSE, warning=FALSE}
final %>%
...
```{r imagem2, message=FALSE, warning=FALSE}
...
```{r imagem3, message=FALSE, warning=FALSE}
