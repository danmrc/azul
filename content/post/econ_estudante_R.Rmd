...
Em março do ano que vem vou dar um "curso" de R na faculdade. Uma imersão rápida de uma semana nesse lindo mundo da análise de dados. Estava montando algum material para as "aulas", procurando motivações razoáveis para que meus colegas _queiram_ perder uma semana de férias programando. 
...
Um modelo é, por definição, algo errado. Subtraímos do mundo à nossa volta pecualiaridades em busca de um objeto mais tratável, matemático. Funciona? Creio que sim. Você, leitor, pode ler minhas palavras diretamente do telefone porque os teoremas de Teoria dos Leilões provados por Vickrey, Milgrom e Wilson nos anos 70-80 fundamentaram os bem-sucedidos leilões de banda larga nos anos 90. Se um parente seu precisar de doação de rim, provavelmente se beneficiará do [Algoritimo de Gale-Shapley](http://www.eecs.harvard.edu/cs286r/courses/fall09/papers/galeshapley.pdf) e para mercados com pareamentos e dos [teoremas (de impossibilidade) demonstrados por Alvin Roth](https://pdfs.semanticscholar.org/cf51/08ca274bdf762193ffdc8d2b2c95208af1b0.pdf). Sim, Shapley e Roth, aqueles laureados com o Nobel de Economia. A obra de outros dois laureados com o Nobel, Roger Myerson e Bengt Holmstrom envolve muitos teoremas e tem aplicações práticas na vida de todos nós. Como um organizador determina as remunerações de uma [equipe que não pode diretamente observar](https://www.jstor.org/stable/3003457?seq=1#page_scan_tab_contents)? Como [regulamos um monopolista se não conhecemos sua curva de custo](https://www.jstor.org/stable/1912769?seq=1#page_scan_tab_contents)? 

Matemática é importante não só para provar teoremas difíceis e levar o Nobel para casa. Eu te garanto que entender por que "deriva e iguala a zero" funciona fica mais fácil. Entender por que um jogo tem Equilíbrio de Nash deixa de ser questão de achar interseções de curvas e sim de entender que isso é consequência do [Teorema do Ponto Fixo de Brouwer](https://pt.wikipedia.org/wiki/Teorema_do_ponto_fixo_de_Brouwer), ou mais, que consumidores têm uma cesta ótima graças ao [Teorema de Bolzano-Weierstrass](https://pt.wikipedia.org/wiki/Teorema_de_Bolzano-Weierstrass). 


# Ok, seu maluco, e o R?

Como já dizia o revolucionário, o mérito da teoria está na prática. Jogar modelos malucos no quadro é uma coisa, _eles serem bons explicadores da realidade é outra completamente diferente_. Aqui entra o R. Uma coisa que me incomoda no ambiente universitário brasileiro de economia é que nós *paramos no tempo*. Nos anos 50 eu chuto, mas talvez no século $XIX$.
...
* [Incentivizing Safer Sexual Behavior: Evidence from a Lottery Experiment on HIV Prevention, de Martina Nyqvist, Lucia Corno , Damien de Walque e Jakob Svensson](https://www.aeaweb.org/articles?id=10.1257/app.20160469)
...
* [Do Political Protests Matter? Evidence from the Tea Party Movement, de Andreas Madestam, Daniel Shoag, Stan Veuger e David Yanagizawa-Drott](https://dash.harvard.edu/bitstream/handle/1/13457753/TeaParty_Protests.pdf?sequence=1)

Exploraram o fato de que chuva alterou a atendência a protestos coordenados nacionalmente nos EUA em cada região e depois cruzou isso com candidatos eleitos nas próximas eleições e filiações no movimento. Um trabalho realmente interessante, saiu na *melhor* revista de economia do mundo, o Quarterly Journal of Economics.

* [The Effect of Female Education on Fertility and Infant Health: Evidence from School Entry Policies Using Exact Date of Birth, de Justin McCrary e Heather Royer](https://www.aeaweb.org/articles?id=10.1257/aer.101.1.158)
...
Esses trabalhos são só três exemplos do que se faz hoje em dia em economia. Tem pouco ou nada a ver com o esoterismo instalado em boa parte dos departametnos de economia nacionais e sim com tratar, explorar e analisar dados. Não só isso, mas tendo cuidado e usando técnicas para procurar relações de causalidade e não só de correlação. Falo mais disso [nesse post aqui se o assunto te interessar](https://azul.netlify.com/2018/12/13/rdd-mixtape/). 

Aprender R é uma porta de entrada para esse mundo, o da pesquisa séria. [Nesse post aqui eu mostrei como replicar um paper muito interessante sobre nepotismo usando dados ingleses do século XIX](https://azul.netlify.com/2018/11/29/patronagem/) com o R. Desde importar os dados que o autor usou até rodar os modelos. 

# E por onde começar?

Antes de mais nada, programar na vida real não é como nos filmes de hackers. Você não vai ficar digitando sem parar por horas a fio olhando para uma tela preta e branca. A maior parte do tempo você vai passar no [StackOverflow](https://stackoverflow.com/) e no [CrossValidated](https://stats.stackexchange.com/) (ambos parte da rede StackExchange de fóruns) tirando dúvidas e procurando gente com o mesmo problema que você. Programar é assim, não se sinta mal com mensagens de erro.
...
* [R para Economistas, de Daniel Coutinho](https://danmrc.github.io/R-para-Economistas/index.html)
...
* [Azul](https://azul.netlify.com/post/)
