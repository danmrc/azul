...
![](/post/Prog_dinamica/img_dens_2a.png)
...
![](/post/Prog_dinamica/img_2_2a.png)
...
Uma maneira de facilitar o problema e permitir alguma dependência temporal é usando cadeias de Markov finitas. Uma cadeia de Markov é um processo estocástico que só depende da realização anterior - por exemplo, um AR(1). No caso, ela é finita se temos um número finito de estados possíveis. [Neste post](https://azul.netlify.com/2018/11/06/sistemas-dinamicos-e-algebra-linear/) eu já usei cadeias de Markov. A transição entre estados é governado por uma matriz, onde cada linha representa a probabilidade de sair do estado linha e ir para o estado coluna. Vamos supor que temos apenas 2 estados e a matriz de transição é a seguinte:
