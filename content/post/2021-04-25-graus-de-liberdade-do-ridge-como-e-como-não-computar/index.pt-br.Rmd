...
**PS.:** Tinha faltado umas inversas nas contas da primeira vez que eu postei - o que é fácil de resolver. Um problema mais grave era que algumas definições de SVD _não usam_ $V$ quadrada, o que jogava a propriedade $(ABC)^{-1} = C^{-1}B^{-1}A^{-1}. A definição do _Elemnts_ usa V quadrada. 
