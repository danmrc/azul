...
$$\mathbf{x_{t}} = C_1 \mathbf{x_{t-1}} + C_2 \mathbf{x_{t-2}} + ... + \mathbf{u_t}$$

 Vamos definir $\mathbf{z_t} = (\mathbf{x_{t} \phantom{0} \mathbf{x_{t-1} \phantom{0} \mathbf{x_{t-2}} \phatom{0} \cdots)$ Podemos criar uma matriz C que é uma salsicha esperta das matrizes $C_1, C_2,...$:

$$C = \begin{pmatrix}
C_1 & C_1 & \cdots & C_{p-1} &C_p\\
I & 0 & \cdots & 0 & 0\\
0 & I & \cdots & 0 &0\\
