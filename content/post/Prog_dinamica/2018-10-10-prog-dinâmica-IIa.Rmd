...
Então, a probabilidade de permanecer no estado 1 é de 0.8; e a probabilidade de migrar para o estado 2, condicional a estar no estado 1, é de 0.2. Vamos estabelecer que o valor do salário em cada estado é (1,2). Nesse caso, podemos calcular o valor esperado analiticamente
