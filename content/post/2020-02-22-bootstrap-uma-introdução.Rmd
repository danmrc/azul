...
Veja que a variância da amostra é `r sd(amostra)` e isso nos dá um intervalo de confiança usando a regra de bolso da normal de `r mean(amostra) - 1.96*sd(amostra)/sqrt(10)` até `r mean(amostra) + 1.96*sd(amostra)/sqrt(10)`. Veja que o intervalo superior até fica bem perto, mas o inferior dá uma diferença de 0.2. 