--[[
based on revealjs-codeblock - enable reveal.js code presentation features
Copyright © 2020 Tim Sokollek

Slightly modified by Daniel Coutinho
...
function CodeBlock(block)
    ...
    if next(css_classes) then
      class_attribute = string.format('class="language-%s match-braces rainbow-braces"',
                                      table.concat(css_classes, ' '))
      table.insert(code_tag_attributes, class_attribute)
      table.insert(pre_tag_attributes,1,'class = "line-numbers"')
    end
