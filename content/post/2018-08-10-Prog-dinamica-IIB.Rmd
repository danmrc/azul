...
* Faça isso até $V$ ou $c$, i.e., até $V_{i}$ e $V_{i+1}$ ficarem próximos numericamente
 ...
 guess = y
 vals = Array{Float64}(150,length(y))
 pol=Array{Float64}(150,length(y))

 vals[1,1:length(y)] = guess
 pol[1,1:length(y)] = y

 for i=1:149
     V=Spline1D(y,vals[i,:],k=1,bc="extrapolate")
...
```
O gráfico deixa bem claro que a solução difere mais no fim.
