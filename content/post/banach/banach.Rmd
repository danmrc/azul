...
#vamos alterar as condições inciais drasticamente

obj1 = contracao(c = 10, A = A, n = n) 
obj2 = contracao(c = 100, A = A, n = n)
obj3 = contracao(c = 1000, A = A, n = n)
obj4 = contracao(c = 10000, A = A, n = n)
x = seq(0, n-1, by = 1)
...
ggplot(dados, aes(x = x))+
  geom_line(aes(y = obj1), color = "red")+
  geom_line(aes(y = obj2), color = "blue")+
  geom_line(aes(y = obj3), color = "green")+
  geom_line(aes(y = obj4), color = "yellow")
