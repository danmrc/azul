...
Vamos usar o R para olhar como é essa distribuição para diferentes valores de $\lambda$, $\beta$ e $\sigma^2_u$. Veja que $\beta \neq 1$ para o problema ser bem definido. Eu vou começar com $\lambda =1$ e vou fixar $\sigma^2_u=1$ e $\beta = 0.6$. 
