...
primeiro_estágio1 <- lm(x ~z)
primeiro_estágio2 <- lm(x2 ~z)
...
stargazer(primeiro_estágio1,primeiro_estágio2, type = "html", column.labels = c("Instrumento Forte","Instrumento Fraco"),model.names = FALSE,omit.stat = c("ser","n"),style = "aer",omit.table.layout = "#")
