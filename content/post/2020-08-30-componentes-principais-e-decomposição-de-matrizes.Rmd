...
Agora, como $\lambda_1$ e $\lambda_n$ são escalares:
...
Então veja que os auto valores de $A^{\prime}A$ são os quadrados dos valores singulares de A e os autovetores são $V$. Uma relação similar vale para $AA^{\prime}$. 
