...
Nós rejeitamos a hipótese nula quando ela é verdadeira em `r pp*100`% dos casos.

## Bibliografia

O Gabriel Vasconcelos fez [um post muito bom no blog dele](https://insightr.wordpress.com/2017/05/12/problems-of-causal-inference-after-selection-of-controls/). Está em inglês. (Gabriel já "apareceu" aqui por ser autor do pacote que usa critério de informação no LASSO).   
