...
dados <- tibble::tibble(
                primeiro = contracao(c = 1, A = A, n = n, soma = s),
                segundo = contracao(c = 3, A = A, n = n, soma = s),
                terceiro = contracao(c = 8, A = A, n = n, soma = s), 
                quarto = contracao(c = 14, A = A, n = n, soma = s),
                x = seq(0, n-1, by = 1)
                )
...
ggplot(dados, aes(x = x)) +
 geom_line(aes(y = primeiro), size = 2) +
  geom_line(aes(y = segundo), color = "blue", size = 2) +
  geom_line(aes(y = terceiro), color = "green", size = 2) +
  geom_line(aes(y = quarto), color = "yellow", size = 2)
