...
Vamos escrever uma função que faz cada um dos passos. Veja que você não precis fazer isso: existe um pacote excelente que já implementa isso no GitHub chamado [HDeconometrics](https://github.com/gabrielrvsc/HDeconometrics), mantido pelo Gabriel Vasconcelos. Mas seguindo o espírito do blog, eu vou implementar "no braço". Eu vou permitir que o usuário escolha qualquer um dos 3 critérios, e para isso eu usarei uns if: 
