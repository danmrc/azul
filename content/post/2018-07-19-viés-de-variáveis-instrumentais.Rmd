...
As simulações acima chamam atenção para o fato de que muitos instrumentos geram viés na estimação por MQ2E, apesar das muitas vantagens de usar muitos instrumentos (testes de sobreidentificação, por exemplo). As simulações mostram que, idealmente, dois instrumentos aproximam a estimação do valor verdadeiro. Mas é um estudo por simulação: não sabemos o quão geral são essas regras e quais características que colocamos na simulação podem ser relaxadas para gerar um resultado semelhante.